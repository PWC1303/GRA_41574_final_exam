from sklearn.metrics import accuracy_score,roc_auc_score,f1_score,precision_score,confusion_matrix,roc_curve,recall_score,average_precision_score
import numpy as np
import json
...
def model_tester(y_te,yhat_prob,model_name,alpha,dset):
        ...
        test_pr_auc = average_precision_score(y_te,yhat_prob)
        test_auc = roc_auc_score(y_te,yhat_prob)
        test_precision = precision_score(y_te, yhat)
